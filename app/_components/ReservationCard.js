        ...
        {!isPast(startDate) ? (
          <>
            <Link
              ...
              className="group flex items-center justify-center md:justify-start gap-2 uppercase text-xs font-bold text-primary-300 border-r md:border-r-0 md:border-b border-primary-800 flex-grow px-3 py-2 md:py-0 hover:bg-accent-600 transition-colors hover:text-primary-900"
            >
